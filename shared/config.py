...
class Config:
    ...
    WINDOW_W, WINDOW_H = 2560, 2560#1080, 1080#3840, 2560
    IMAGE_SIZE = 512
    GRID_SIZE = 128
    ...
    STYLE = {
        "Botanical Lithograph": {
            ...
            "short": "distant subject in vast empty space, botanical lithograph, pale salmon, sage green",
        ...
        "Art Nouveau Engraving": {
            ...
            "short": "distant subject in vast empty space, Art Nouveau engraving, gold, ivory, amber filigree",
        ...
        "Deep-Sea Specimen": {
            ...
            "short": "distant subject in vast empty space, deep-sea specimen, cyan, violet, mint",
        ...
        "Edo Woodblock": {
            "name": "Edo Woodblock",
            "short": "distant subject in vast empty space, Edo woodblock, vermillion, indigo, cream",
        ...
        "Medieval Manuscript": {
            ...
            "short": "distant subject in vast empty space, medieval manuscript, ultramarine, gold leaf, crimson",
        ...
        "Bauhaus Geometric": {
            ...
            "short": "distant subject in vast empty space, Bauhaus geometric abstraction, red, white, yellow",
        ...
        "Electron Microscope": {
            ...
            "short": "distant subject in vast empty space, electron microscope, silver, platinum, graphite",
            "long": "In the style of electron microscope scanning photography. Monochromatic silver, platinum, and graphite on solid black.",
        },
        "Cyanotype": {
            "name": "Cyanotype",
            "short": "distant subject in vast empty space, cyanotype, Prussian blue, white silhouettes",
            "long": "In the style of cyanotype photogram. Prussian blue and white silhouettes on solid black.",
        },
        "Charred Woodblock": {
            "name": "Charred Woodblock",
            "short": "distant subject in vast empty space, charred woodblock, burnt sienna, ash white, ember orange",
            "long": "In the style of charred woodblock relief print. Burnt sienna, ash white, and ember orange on solid black.",
        },
        "Aztec Circuit": {
            "name": "Aztec Circuit",
            "short": "distant subject in vast empty space, Aztec circuit, jade green, obsidian, blood red",
        ...
        "Soviet Constructivist": {
            ...
            "short": "distant subject in vast empty space, Soviet Constructivist, red, steel grey, bone white",
        ...
        "Alchemical Manuscript": {
            ...
            "short": "distant subject in vast empty space, alchemical manuscript, copper green, silver, sulfur yellow",
        ...
        "Light Painting": {
            "name": "Light Painting",
            "short": "distant subject in vast empty space, light painting, magenta, blue, gold trails",
        ...
        "Laser-Etched Glass": {
            ...
            "short": "distant subject in vast empty space, laser-etched glass, white, ice blue",
        ...
        "Pre-Columbian Textile": {
            ...
            "short": "distant subject in vast empty space, Pre-Columbian textile, terracotta, turquoise, maize yellow",
        ...
        "Dutch Mezzotint": {
            ...
            "short": "distant subject in vast empty space, Dutch mezzotint, velvety blacks, silver highlights, sepia",
        ...
        "Islamic Geometric": {
            ...
            "short": "distant subject in vast empty space, Islamic geometric, lapis, copper, ivory",
        ...
        "Alhambra Geometry": {
            ...
            "short": "distant subject in vast empty space, Alhambra geometry, rose gold, silver, warm white",
        ...
        "Bauhaus Textile": {
            ...
            "short": "distant subject in vast empty space, Bauhaus textile, black and white blocks, gold threads",
        ...
        "Kusama Infinity Dots": {
            ...
            "short": "distant subject in vast empty space, Kusama dots, white polka dots, gold outlines",
        ...
        "Inflated Textiles": {
            ...
            "short": "distant subject in vast empty space, inflated textiles, ivory organza, black polka dots, sculptural volumes",
        ...
        "Cinematic B&W": {
            "name": "Cinematic B&W",
            "short": "distant subject in vast empty space, cinematic black and white, orange accents",
            "long": "Cinematic style, photography, ultra detailed, black and white with some NY cabs orange.",
        },
        "Van Gogh": {
            "name": "Van Gogh",
            "short": "distant subject in vast empty space, Van Gogh, impasto strokes",
            "long": "by Van Gogh, impasto strokes",
        },
        "Theo Jansen": {
            "name": "Theo Jansen",
            "short": "distant subject in vast empty space, Theo Jansen, kinetic machines",
            "long": "by Theo Jansen, kinetic machines",
        },
        "Mario Giacomelli": {
            "name": "Mario Giacomelli",
            "short": "distant subject in vast empty space, Mario Giacomelli, black and white",
            "long": "by Mario Giacomelli, black and white",
        },
        "Karl Blossfeldt": {
            "name": "Karl Blossfeldt",
            "short": "distant subject in vast empty space, Karl Blossfeldt, botanical photography",
            "long": "by Karl Blossfeldt, botanical photography",
        },
        "Hiroshi Sugimoto": {
            "name": "Hiroshi Sugimoto",
            "short": "distant subject in vast empty space, Hiroshi Sugimoto, minimalist polarized color",
            "long": "by Hiroshi Sugimoto, minimalist polarized color",
        },
        "Ellsworth Kelly": {
            "name": "Ellsworth Kelly",
            "short": "distant subject in vast empty space, Ellsworth Kelly, vibrant color fields",
            "long": "by Ellsworth Kelly, vibrant color field minimalism",
        },
        "Edward Hopper": {
            "name": "Edward Hopper",
            "short": "distant subject in vast empty space, Edward Hopper, minimal color composition",
            "long": "by Edward Hopper, minimal color composition",
        },
        "James Turrell": {
            "name": "James Turrell",
            "short": "distant subject in vast empty space, James Turrell, neon light art",
            "long": "by James Turrell, minimalist neon light art",
        },
        "Giorgio Morandi": {
            "name": "Giorgio Morandi",
            "short": "distant subject in vast empty space, Giorgio Morandi, muted still life",
            "long": "by Giorgio Morandi, muted color still life minimalism",
        },
        "Lewis Baltz": {
            "name": "Lewis Baltz",
            "short": "distant subject in vast empty space, Lewis Baltz, new topographics color",
            "long": "by Lewis Baltz, new topographics color photography",
        },
        "Georgia O'Keeffe": {
            "name": "Georgia O'Keeffe",
            "short": "distant subject in vast empty space, Georgia O'Keeffe, minimalist abstract color",
            "long": "by Georgia O'Keeffe, minimalist abstract color",
        },
        "Patrick Caulfield": {
            "name": "Patrick Caulfield",
            "short": "distant subject in vast empty space, Patrick Caulfield, graphic minimalism",
            "long": "by Patrick Caulfield, graphic minimalism color",
        },
        "Michael Kenna": {
            "name": "Michael Kenna",
            "short": "distant subject in vast empty space, Michael Kenna, minimal color photography",
            "long": "by Michael Kenna, minimal color photography",
        },
        "Fashion": {
            "name": "Fashio",
            "short": "distant subject in vast empty space, high-fashion editorial, sculptural wardrobe, theatrical lighting",
        ...
        "Barcode": {
            "name": "Barcode",
            "short": "distant subject in vast empty space, barcode stripes, sumi-e faces, black and white",
        ...
        "Renaissance Painting": {
            ...
            "short": "distant subject in vast empty space, Renaissance oil painting, earth tones, chiaroscuro",
        ...
        "Japanese Ink Wash": {
            ...
            "short": "distant subject in vast empty space, Japanese ink wash, misty mountains, cherry blossoms",
        ...
        "Impressionist Garden": {
            ...
            "short": "distant subject in vast empty space, Impressionist garden, Monet palette, visible brushstrokes",
        ...
        "World War I": {
            "name": "World War I",
            "short": "distant subject in vast empty space, World War I, primary color fields, goggles, rain coats",
        ...
        "Watercolor Skies": {
            ...
            "short": "distant subject in vast empty space, watercolor skies, blue ocean clouds, silhouette linework",
        ...
        "Rennaissance Tricycle": {
            ...
            "short": "distant subject in vast empty space, Renaissance portrait, tiny tricycle, warm reds and golds",
        ...
        "Rennaissance Duck": {
            ...
            "short": "distant subject in vast empty space, Renaissance portrait, giant yellow duck, warm reds and golds",
        ...
        "Rennaissance Angels": {
            ...
            "short": "distant subject in vast empty space, Baroque ceiling fresco, angels, duck, divine clouds",
        ...
        "Monet Flamingo": {
            "name": "Monet Flamingo",
            "short": "distant subject in vast empty space, Monet garden, pink flamingo floatie, water lilies",
        ...
        "Dali": {
            "name": "Dali",
            "short": "distant subject in vast empty space, Dalí surreal desert, melting clocks, impossible shadows",
        ...
        "Rococo Unicorn": {
            "name": "Rococo Unicorn",
            "short": "distant subject in vast empry space, Rococo garden party, inflatable unicorn, pastel romance",
        ...
        "New Year": {
            "name": "New Year",
            "short": "distant subject in vast empty space, Pollock abstract expressionism, champagne, gold splatter",
        ...
        "Rembrandt selfie stick": {
            ...
            "short": "distant subject in vast empty space, Rembrandt portrait, chiaroscuro, selfie stick, Dutch interior",
